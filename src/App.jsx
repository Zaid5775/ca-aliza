  ...
  return (
    <div className="flex flex-col items-center mt-6 md:mt-10">
      ...
      <button
        ...
        className="mt-4 px-5 py-2 bg-[#FFC4C4] text-white rounded-full shadow-md text-sm md:text-base"
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="px-5 py-2 bg-[#FFC4C4] text-white rounded-full shadow-md text-sm md:text-base block mx-auto"
              style={{ fontFamily: "Nunito" }}
            >
              Close 💞
            </button>
    ...
    <div className="text-center mt-16 mb-24 px-3">
      {!open && (
        <motion.button
          ...
          className="px-8 py-3 bg-[#FFC4C4] text-white rounded-full shadow-md text-lg md:text-xl"
          style={{ fontFamily: "Nunito" }}
  ...
  return (
    <div className="mt-20 text-center">
      <button
        ...
        className="px-8 py-3 bg-[#FFC4C4] text-white rounded-full shadow-md text-lg"
        style={{ fontFamily: "Nunito" }}
      >
        You want a hug??? 🤗🐼
      </button>
